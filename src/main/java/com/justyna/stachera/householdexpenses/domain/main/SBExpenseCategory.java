 ...
 * Date: 02.01.2018
 * <p>
 * POJO class which represents 'sbexpense_category' table from database.
...
@AllArgsConstructor
@Builder
public class SBExpenseCategory
{
    /**
     * {@link SBExpenseCategory} object ID. It is auto-generated.
     */
    @Id
    @GeneratedValue
    private Long id;
