 ...
 * Date: 02.01.2018
 *
 * Enum which contains values needed to sort 'sbcapitalisation' records and viewing notifications on drop list.
 */
public enum SBCapitalisationFields
{
    id_asc("ID", "rosnąco"),
    id_desc("ID", "malejąco"),
     ...
     */
    SBCapitalisationFields(String value, String order)
    {
        this.value = value;
        this.order = order;
    }
    ...
    {
        return Arrays.asList(SBCapitalisationFields.values())
                     .stream()
    ...
    public static List<String> getList()
    {
        ...
        for (SBCapitalisationFields s : SBCapitalisationFields.values())
        {
