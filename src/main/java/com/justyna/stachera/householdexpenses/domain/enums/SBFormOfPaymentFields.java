 ...
 * Date: 02.01.2018
 *
 * Enum which contains values needed to sort 'sbform_of_payment' records and viewing notifications on drop list.
 */
public enum SBFormOfPaymentFields
{
    id_asc("ID", "rosnąco"),
    id_desc("ID", "malejąco"),
     ...
     */
    SBFormOfPaymentFields(String value, String order)
    {
        this.value = value;
        this.order = order;
    }
    ...
    {
        return Arrays.asList(SBFormOfPaymentFields.values())
                     .stream()
    ...
    public static List<String> getList()
    {
        ...
        for (SBFormOfPaymentFields s : SBFormOfPaymentFields.values())
        {
